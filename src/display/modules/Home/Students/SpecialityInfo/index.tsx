...
class SpecialityInfoSearch extends React.PureComponent<IProps, IState> {
    ...
    getList = async () => {
        ...
        if (res) {
            this.setState({
                achievementList: res.results ? res.results.data : [],
    ...
    */
    getCampusClassList = async () => {
        ...
        if (res) {
            this.setState({
                classList: res.results ? res.results.data : [],
            });
        }
    }
    ...
    getSpecialityType = async () => {
        ...
        if (res) {
            this.setState({
                specialityTypeList: res.results ? res.results.data : [],
            });
        }
    }
    ...
    getDictList = async () => {
        ...
        if (res) {
            this.setState({
                dictList: res.results ? res.results.data : [],
            });
        }
    }
