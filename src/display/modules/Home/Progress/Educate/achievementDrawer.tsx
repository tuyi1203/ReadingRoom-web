        ...
        {type === '3' &&
          <span>
            ...
            <Row style={{ marginBottom: 12 }}>
              ...
              <Col span={6}>
                <DescriptionItem
                  value={drawerData && drawerData.lecture_date && moment(drawerData.lecture_date).format('YYYY-MM')}
                />
              </Col>
              <Col span={6}>
              ...
              <Col span={6}>
                <DescriptionItem
                  value={drawerData && drawerData.lecture_content}
                />
              </Col>
            </Row>
            <Row style={{ marginBottom: 12 }}>
              ...
              <Col span={6}>
                <DescriptionItem
                  value={drawerData && drawerData.lecture_person}
                />
              </Col>
              <Col span={6}>
              ...
              <Col span={6}>
                <DescriptionItem
                  value={drawerData && drawerData.lecture_organization}
                />
              </Col>
            </Row>
            <Row style={{ marginBottom: 12 }}>
              ...
              <Col span={6}>
                <DescriptionItem
                  value={drawerData && drawerData.lecture_scope && _.find(getOption('award_level'), ['value', drawerData.lecture_scope.toString()])?.label}
                />
              </Col>
              <Col span={6}>
                <DescriptionItem value="主办单位" />
