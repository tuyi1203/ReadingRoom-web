      ...
      <Form className="modal-form" layout="inline" labelCol={{ span: 10 }} wrapperCol={{ span: 14 }}>
        ...
        {defaultActiveKey === '2' &&
          <span>
            ...
            <FormItem label="交流管理经验时间" style={{ margin: 0 }}>
              {
                getFieldDecorator('manage_exp_communicate_date', {
                  initialValue: editData && editData.manage_exp_communicate_date ? moment(editData.manage_exp_communicate_date, 'YYYY-MM') : null,
                  // initialValue: record[dataIndex],
                })
                  (<MonthPicker />)
              }
            </FormItem >
            <FormItem label="交流管理经验内容">
              {getFieldDecorator('manage_exp_communicate_content', {
                initialValue: editData ? editData.manage_exp_communicate_content : null,
                rules: [
                  // { required: true, message: '请输入姓名' }
                ],
              })(
            ...
            <FormItem label="本人作用">
              {getFieldDecorator('manage_exp_communicate_role', {
                initialValue: editData ? editData.manage_exp_communicate_role : null,
                rules: [
                  // { required: true, message: '请输入姓名' }
                ],
              })(
            ...
            <FormItem label="交流范围">
              {getFieldDecorator('manage_exp_communicate_range', {
                initialValue: editData ? editData.manage_exp_communicate_range : null,
                rules: [
                  // { required: true, message: '请输入姓名' }
                ],
              })(
