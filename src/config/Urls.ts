enum Urls {
    ...
    getEducateBaseInfoDetail = '/progress/educate/detail', // 获取教学成果基本填报信息
    addOrEditEducateBaseInfo = '/progress/educate/edit/', // 添加或修改教学成果基本信息
    getEducateAchievementList = '/progress/educate/achievement/', // 获取用户教学成果列表
    editEducateAchievement = '/progress/educate/achievement/{id}', // 修改用户教学成果数据
    ...
    // -----------常用功能接口------------
    getTasksInfoList = '/notifications',  // 获取常用功能待办提醒列表
    setNoticeswitch = '/notifications/setting',  // 设置通知开关
    createNotice = '/notifications',  // 创建通知
    updateNotice = '/notifications',  // 修改通知 
    deleteNotice = '/notifications',  // 删除通知
    downloadtemplate = '/notifications/excel/template',  // 下载提醒Excel模板
    uploadtemplate = '/notifications/excel', // 上传提醒表
    switchinfo = '/notifications/setting', // 查询通知开关是否开启信息 
    getpersontable = '/school_timetable/my', // 获取个人课表
    getschooltable = '/school_timetable/tree', // 获取全部课表
